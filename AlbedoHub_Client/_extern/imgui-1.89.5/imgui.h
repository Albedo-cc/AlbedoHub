...
// Parameters file with compile-time options
...
struct ImFontConfig;                // Parameters data when adding a font or merging fonts
...
// Parameters flags stored in io.ConfigFlags. Set by user/application.
...
struct ImFontAtlas
{
    ...
    ImVector<ImFontConfig>      ConfigData;         // Parameters data
