...
#include <stb_image.h>
    ...
    using namespace Albedo::Hub::client::layer;
    ...
    uint32_t ImageLoader::findMemoryType(uint32_t type_filter, VkMemoryPropertyFlags properties)
    {
    ...
    bool ImageLoader::LoadTextureFromFile(const char* filename, VulkanImage* tex_data)
    {
    ...
    void ImageLoader::RemoveTexture(VulkanImage* tex_data)
    {
