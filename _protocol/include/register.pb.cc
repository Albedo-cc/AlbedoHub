...
const uint32_t TableStruct_register_2eproto::offsets[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  ~0u,  // no _has_bits_
  PROTOBUF_FIELD_OFFSET(::Register::UserInfo, _internal_metadata_),
  ~0u,  // no _extensions_
  ~0u,  // no _oneof_case_
  ~0u,  // no _weak_field_map_
  ~0u,  // no _inlined_string_donated_
  PROTOBUF_FIELD_OFFSET(::Register::UserInfo, _impl_.account_),
  PROTOBUF_FIELD_OFFSET(::Register::UserInfo, _impl_.password_),
  PROTOBUF_FIELD_OFFSET(::Register::UserInfo, _impl_.name_),
};
static const ::_pbi::MigrationSchema schemas[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  { 0, -1, -1, sizeof(::Register::UserInfo)},
};

static const ::_pb::Message* const file_default_instances[] = {
  &::Register::_UserInfo_default_instance_._instance,
};
...
const ::_pbi::DescriptorTable descriptor_table_register_2eproto = {
    false, false, 95, descriptor_table_protodef_register_2eproto,
    "register.proto",
...
UserInfo::UserInfo(::PROTOBUF_NAMESPACE_ID::Arena* arena,
  ...
  // @@protoc_insertion_point(arena_constructor:Register.UserInfo)
}
UserInfo::UserInfo(const UserInfo& from)
  ...
  // @@protoc_insertion_point(copy_constructor:Register.UserInfo)
}
...
UserInfo::~UserInfo() {
  // @@protoc_insertion_point(destructor:Register.UserInfo)
...
void UserInfo::Clear() {
// @@protoc_insertion_point(message_clear_start:Register.UserInfo)
    ...
    switch (tag >> 3) {
      ...
      case 1:
        if (PROTOBUF_PREDICT_TRUE(static_cast<uint8_t>(tag) == 10)) {
          ...
          CHK_(ptr);
          CHK_(::_pbi::VerifyUTF8(str, "Register.UserInfo.account"));
        } else
          goto handle_unusual;
        continue;
      // string password = 2;
      case 2:
        if (PROTOBUF_PREDICT_TRUE(static_cast<uint8_t>(tag) == 18)) {
          ...
          ptr = ::_pbi::InlineGreedyStringParser(str, ptr, ctx);
          CHK_(ptr);
          CHK_(::_pbi::VerifyUTF8(str, "Register.UserInfo.password"));
        } else
          goto handle_unusual;
        continue;
      // string name = 3;
      case 3:
        if (PROTOBUF_PREDICT_TRUE(static_cast<uint8_t>(tag) == 26)) {
          ...
          ptr = ::_pbi::InlineGreedyStringParser(str, ptr, ctx);
          CHK_(ptr);
          CHK_(::_pbi::VerifyUTF8(str, "Register.UserInfo.name"));
        } else
          goto handle_unusual;
        continue;
      default:
...
uint8_t* UserInfo::_InternalSerialize(
  ...
  // @@protoc_insertion_point(serialize_to_array_start:Register.UserInfo)
  uint32_t cached_has_bits = 0;
  (void) cached_has_bits;
  ...
  // @@protoc_insertion_point(serialize_to_array_end:Register.UserInfo)
  return target;
}

size_t UserInfo::ByteSizeLong() const {
// @@protoc_insertion_point(message_byte_size_start:Register.UserInfo)
  size_t total_size = 0;
...
void UserInfo::MergeImpl(::PROTOBUF_NAMESPACE_ID::Message& to_msg, const ::PROTOBUF_NAMESPACE_ID::Message& from_msg) {
  ...
  // @@protoc_insertion_point(class_specific_merge_from_start:Register.UserInfo)
...
// @@protoc_insertion_point(class_specific_copy_from_start:Register.UserInfo)
  if (&from == this) return;
  Clear();
  MergeFrom(from);
}
...
template<> PROTOBUF_NOINLINE ::Register::UserInfo*
Arena::CreateMaybeMessage< ::Register::UserInfo >(Arena* arena) {
  return Arena::CreateMessageInternal< ::Register::UserInfo >(arena);
}
