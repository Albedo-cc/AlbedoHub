...
constexpr Type Type_MIN = FAILED;
constexpr Type Type_MAX = LOGIN;
...
template <> struct is_proto_enum< ::Message::Type> : ::std::true_type {};
template <>
inline const EnumDescriptor* GetEnumDescriptor< ::Message::Type>() {
  return ::Message::Type_descriptor();
}
